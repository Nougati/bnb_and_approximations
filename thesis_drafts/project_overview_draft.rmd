...
Implicit enumeration refers to a divide and conquer problem solving strategy
 where one enumerates through a problem's search space without specifically
...
Known to be NP-Complete \cite{kellerer2004introduction}, KP has been studied
 extensively both in to solving optimally and approximately (see, for example
...
The preprocessing step proposed involves, just as in previous FPTAS's, making
 a distinction between items with large profit, and items with small profit. 
Then, all profits which are deemed to be large are sorted into 
...
The authors introduce what they refer to as a *vector merging problem*, which
 ...
 - Give a broad overview of scaling reduction
 - Give a broad overview of interval DP
 - Give a broad overview of vector merge
