...
In this report, we consider maximisation problems whose constraints are all
 linear\cite{alizadeh1995interior}, on the other hand, are characterised by having one or more variables
...
Known to be NP-Complete \cite{kellerer2004introduction}, KP has been studied extensively both in to solving
...
The this produced  the only implicit enumeration scheme leveraging AA guarantees
