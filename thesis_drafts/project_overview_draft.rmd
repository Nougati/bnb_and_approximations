...
This distillation of their algorithm, as described by
...
The approach described by \cite{ibarra1975fast} builds on this core approach by
 improving the nuance of the preprocessing step, which we know describe.
The first improvement results from acknowledging that while a given input
 ...
 value of an optimal solution will likely be from high value items \textsc{this
 doesn't seem like the actual reason}. 
